...
//
//    Basic unpack tilize operation implemented using Tanto host API.
// 
...
UnpackTilize::UnpackTilize() { }

UnpackTilize::~UnpackTilize() { }

void UnpackTilize::init(
...
void UnpackTilize::run(const void *x, void *y) {
...
void UnpackTilize::create_globals() {
...
void UnpackTilize::create_pipes() {
    m_px =
        core::Pipe(
            m_program,
            m_grid,
...
void UnpackTilize::create_kernels() {
    create_reader();
    create_writer();
    create_math();
}

void UnpackTilize::create_reader() {
    std::string path = m_kernel_base_path + "/unpack_tilize_reader.cpp";
    m_reader = 
        core::Kernel(
            m_program, 
            m_grid, 
...
void UnpackTilize::create_writer() {
    std::string path = m_kernel_base_path + "/unpack_tilize_writer.cpp";
    m_writer = 
        core::Kernel(
            m_program, 
            m_grid, 
...
void UnpackTilize::create_math() {
    std::string path = m_kernel_base_path + "/unpack_tilize_math.cpp";
    m_math = 
        core::Kernel(
            m_program, 
            m_grid, 
