                                   ...
                                   const string& input_hlk_file_path)
{
    ...
    gen_kernel_cpp(abs_file_path, unpack_cpp, unpack_prolog);
    gen_kernel_cpp(abs_file_path, math_cpp, math_prolog);
    gen_kernel_cpp(abs_file_path, pack_cpp, pack_prolog);
