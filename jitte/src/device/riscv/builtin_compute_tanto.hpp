...
#define COMPUTE_TANTO_BUILTINS \
    DECL_BUILTIN(tanto_compute_init, 0) \
    ...
    DECL_BUILTIN(tanto_unpack_reduce_rows_init, 2) \
    DECL_BUILTIN(tanto_unpack_reduce_cols_init, 2) \
    DECL_BUILTIN(tanto_unpack_reduce_scalar_init, 2) \
    ...
    DECL_BUILTIN(tanto_pack_row_init, 1) \
    DECL_BUILTIN(tanto_pack_col_init, 1) \
    DECL_BUILTIN(tanto_pack_scalar_init, 1)
