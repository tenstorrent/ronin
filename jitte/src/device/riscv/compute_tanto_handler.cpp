...
void tanto_compute_init(Compute *api, Riscv32Core *core) {
    api->tanto_compute_init();
}
...
void tanto_max_init(Compute *api, Riscv32Core *core) {
    api->tanto_max_init();
}
...
void tanto_unpack_reduce_rows_init(Compute *api, Riscv32Core *core) {
    uint32_t icb0 = core->get_arg(0);
    uint32_t icb1 = core->get_arg(1);
    api->tanto_unpack_reduce_rows_init(icb0, icb1);
}

void tanto_unpack_reduce_cols_init(Compute *api, Riscv32Core *core) {
    uint32_t icb0 = core->get_arg(0);
    uint32_t icb1 = core->get_arg(1);
    api->tanto_unpack_reduce_cols_init(icb0, icb1);
}

void tanto_unpack_reduce_scalar_init(Compute *api, Riscv32Core *core) {
    uint32_t icb0 = core->get_arg(0);
    uint32_t icb1 = core->get_arg(1);
    api->tanto_unpack_reduce_scalar_init(icb0, icb1);
}
...
void tanto_pack_row_init(Compute *api, Riscv32Core *core) {
    uint32_t ocb = core->get_arg(0);
    api->tanto_pack_row_init(ocb);
}

void tanto_pack_col_init(Compute *api, Riscv32Core *core) {
    uint32_t ocb = core->get_arg(0);
    api->tanto_pack_col_init(ocb);
}

void tanto_pack_scalar_init(Compute *api, Riscv32Core *core) {
    uint32_t ocb = core->get_arg(0);
    api->tanto_pack_scalar_init(ocb);
}
