...
#if 0 // TODO: Revise this (disabled to avoid name conflicts with "cb_api.hpp")
...
// ReduceFunc::Avg meeded only on tensor level to compute correct coefficient. Kernel uses Sum.
...
constexpr uint32_t 
    NUM_MAX_IN_BUFFERS_PER_CORE = HlkOperand::in7 - HlkOperand::in0 + 1,
    NUM_MAX_PARAM_BUFFERS_PER_CORE = HlkOperand::param7 - HlkOperand::param0 + 1,
    NUM_MAX_OUT_BUFFERS_PER_CORE = HlkOperand::out7 - HlkOperand::out0 + 1,
    NUM_MAX_INTERMED_BUFFERS_PER_CORE = HlkOperand::intermed7 - HlkOperand::intermed0 + 1;
