...
#include "host/tanto/mobilenetv2_050_global_dsc.hpp"
...
// FCParam: H C K
// DSConv2dParam: H W C P Q K R S pad_h pad_w stride_h stride_w dilation_h dilation_w post_op
...
DSConv2dParam conv3 = {112, 112, 16, 112, 112, 8, 3, 3, 1, 1, 1, 1, 1, 1, relu6};
...
DSConv2dParam conv8 = {112, 112, 48, 56, 56, 16, 3, 3, 1, 1, 2, 2, 1, 1, relu6};
...
DSConv2dParam conv13 = {56, 56, 96, 56, 56, 16, 3, 3, 1, 1, 1, 1, 1, 1, relu6};
...
DSConv2dParam conv19 = {56, 56, 96, 28, 28, 16, 3, 3, 1, 1, 2, 2, 1, 1, relu6};
...
DSConv2dParam conv24 = {28, 28, 96, 28, 28, 16, 3, 3, 1, 1, 1, 1, 1, 1, relu6};
...
DSConv2dParam conv36 = {28, 28, 96, 14, 14, 32, 3, 3, 1, 1, 2, 2, 1, 1, relu6};
...
DSConv2dParam conv41a = {14, 14, 192, 14, 14, 32, 3, 3, 1, 1, 1, 1, 1, 1, relu6}; // [conv43]
DSConv2dParam conv41b = {14, 14, 192, 14, 14, 48, 3, 3, 1, 1, 1, 1, 1, 1, relu6}; // [conv61]
...
DSConv2dParam conv64 = {14, 14, 288, 14, 14, 48, 3, 3, 1, 1, 1, 1, 1, 1, relu6};
...
DSConv2dParam conv76 = {14, 14, 288, 7, 7, 80, 3, 3, 1, 1, 2, 2, 1, 1, relu6};
...
DSConv2dParam conv81a = {7, 7, 480, 7, 7, 80, 3, 3, 1, 1, 1, 1, 1, 1, relu6}; // [conv83]
DSConv2dParam conv81b = {7, 7, 480, 7, 7, 160, 3, 3, 1, 1, 1, 1, 1, 1, relu6}; // [conv95]
...
MobileNetV2_050_GlobalDsc::MobileNetV2_050_GlobalDsc(
...
void MobileNetV2_050_GlobalDsc::init(const std::string &data_dir) {
    NetGlobal::set_data_dir(data_dir);
    init_layers();
    load_buffers();
}

int MobileNetV2_050_GlobalDsc::input_count() {
    return 1;
}

void MobileNetV2_050_GlobalDsc::set_input(int index, const std::vector<float> &data) {
    assert(index == 0);
...
int MobileNetV2_050_GlobalDsc::output_count() {
    return 1;
}

void MobileNetV2_050_GlobalDsc::get_output(int index, std::vector<float> &data) {
    assert(index == 0);
...
void MobileNetV2_050_GlobalDsc::init_conv2d(
        int ix,
        int iw,
        int ib,
        int iz,
...
void MobileNetV2_050_GlobalDsc::init_fc(
        int ix,
        int iw,
        int ib,
        int iy,
...
void MobileNetV2_050_GlobalDsc::init_ds_conv2d(
        int ix,
        int iw,
        int ib,
        int iw2,
...
void MobileNetV2_050_GlobalDsc::init_reduce_mean(
        int ix,
        int iy,
