...
//
//    MobileNetV2_050_Global
//

MobileNetV2_050_Global::MobileNetV2_050_Global(
...
void MobileNetV2_050_Global::init(const std::string &data_dir) {
    NetGlobal::set_data_dir(data_dir);
    init_layers();
    load_buffers();
}

int MobileNetV2_050_Global::input_count() {
    return 1;
}

void MobileNetV2_050_Global::set_input(int index, const std::vector<float> &data) {
    assert(index == 0);
...
int MobileNetV2_050_Global::output_count() {
    return 1;
}

void MobileNetV2_050_Global::get_output(int index, std::vector<float> &data) {
    assert(index == 0);
...
void MobileNetV2_050_Global::run() {
    NetGlobal::run();
}

void MobileNetV2_050_Global::init_layers() {
...
void MobileNetV2_050_Global::load_buffers() {
...
void MobileNetV2_050_Global::init_conv2d(
        int ix,
        int iw,
        int ib,
        int iz,
...
void MobileNetV2_050_Global::init_fc(
        int ix,
        int iw,
        int ib,
        int iy,
...
void MobileNetV2_050_Global::init_group_conv2d(
        int ix,
        int iw,
        int ib,
        int iz,
...
void MobileNetV2_050_Global::init_reduce_mean(
        int ix,
        int iy,
