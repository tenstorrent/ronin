...
#else
            auto activations_tile_layout = convert_to_tile_layout<bfloat16, vector>(activations_tilized);
#endif
...
#else
        auto weights_tile_layout = convert_to_tile_layout<bfloat16, vector>(identity_tilized);
#endif
