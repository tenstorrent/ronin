...
#else
        auto activations_tile_layout = convert_to_tile_layout<bfloat16, std::vector>(tensor.get_values());
#endif
        auto activations = pack_bfloat16_vec_into_uint32_vec(activations_tile_layout);
#if 0 // [RONIN]
        tt_metal::detail::WriteToBuffer(src0_dram_buffer, activations);
#else
        tt_metal::EnqueueWriteBuffer(cq, src0_dram_buffer, activations, false);
#endif
...
#else
        auto weights_tile_layout = convert_to_tile_layout<bfloat16, std::vector>(identity);
#endif
