...
struct AddrMap {
    ...
    static constexpr uint32_t 
        BRISC_L1_ARG_BASE = 101 * 1024,
        BRISC_L1_RESULT_BASE = 102 * 1024,
        NCRISC_L1_ARG_BASE = 103 * 1024,
        NCRISC_L1_RESULT_BASE = 104 * 1024,
        TRISC_L1_ARG_BASE = 105 * 1024;
#endif
    static constexpr uint32_t 
    ...
    static constexpr uint32_t 
#if 0 // TODO: Revise this
        CIRCULAR_BUFFER_CONFIG_BASE = 106 * 1024,
#endif
