...
//#include "impl/debug/dprint_server.hpp" // [RONIN]
//#include "impl/debug/watcher_server.hpp" // [RONIN]
...
// [RONIN] SKIPPED: Device::compile_command_queue_programs
// [RONIN] SKIPPED: Device::configure_command_queue_programs
...
void Device::initialize_command_queue() {
...
#endif
    // [RONIN] TODO: Pass Prefetch API to CQManager constructor
    this->cq_manager_ = 
    ...
    // [RONIN] SKIPPED: Initialize command queue programs
#if 0 // TODO: Revise this
...
#endif
    data = std::move(this->cq_manager()->get_bypass_data());
