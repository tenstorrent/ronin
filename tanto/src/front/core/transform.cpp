...
RewriteRule Transform::make_pass2_compute_rule() {
    ...
    return applyFirst({
        ...
        rf.make_math_copy_dst_rule(),
        rf.make_math_add_dst_rule(),
        rf.make_math_sub_dst_rule(),
        rf.make_math_rsub_dst_rule(),
        rf.make_math_mul_dst_rule(),
        rf.make_math_div_dst_rule(),
        rf.make_math_power_dst_rule(),
        rf.make_math_abs_rule(),
        rf.make_math_acos_rule(),
        rf.make_math_add_scalar_rule(),
        rf.make_math_asin_rule(),
        rf.make_math_atan_rule(),
        rf.make_math_cast_bf16_u16_rule(),
        rf.make_math_cast_u16_bf16_rule(),
        rf.make_math_ceil_rule(),
        ...
        rf.make_math_fill_rule(),
        rf.make_math_floor_rule(),
        ...
        rf.make_copy_dst_init_rule(),
        rf.make_add_dst_init_rule(),
        rf.make_sub_dst_init_rule(),
        rf.make_rsub_dst_init_rule(),
        rf.make_mul_dst_init_rule(),
        rf.make_div_dst_init_rule(),
        rf.make_power_dst_init_rule(),
        rf.make_abs_init_rule(),
        rf.make_acos_init_rule(),
        rf.make_asin_init_rule(),
        rf.make_atan_init_rule(),
        rf.make_binary_scalar_init_rule(),
        rf.make_cast_init_rule(),
        rf.make_ceil_init_rule(),
        ...
        rf.make_fill_init_rule(),
        rf.make_floor_init_rule(),
...
RewriteRule Transform::make_pass2_dataflow_rule(bool write_mode) {
    ...
    return applyFirst({
        ...
        // pipe (dataflow)
        rf.make_pipe_get_rule(),
        rf.make_pipe_set_rule(),
