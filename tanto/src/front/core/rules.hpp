...
public:
    ...
    RewriteRule make_math_copy_dst_rule();
    RewriteRule make_math_add_dst_rule();
    RewriteRule make_math_sub_dst_rule();
    RewriteRule make_math_rsub_dst_rule();
    RewriteRule make_math_mul_dst_rule();
    RewriteRule make_math_div_dst_rule();
    RewriteRule make_math_power_dst_rule();
    ...
    RewriteRule make_math_cast_bf16_u16_rule();
    RewriteRule make_math_cast_u16_bf16_rule();
    RewriteRule make_math_ceil_rule();
    ...
    RewriteRule make_math_fill_rule();
    RewriteRule make_math_floor_rule();
    ...
    RewriteRule make_copy_dst_init_rule();
    RewriteRule make_add_dst_init_rule();
    RewriteRule make_sub_dst_init_rule();
    RewriteRule make_rsub_dst_init_rule();
    RewriteRule make_mul_dst_init_rule();
    RewriteRule make_div_dst_init_rule();
    RewriteRule make_power_dst_init_rule();
    ...
    RewriteRule make_cast_init_rule();
    RewriteRule make_ceil_init_rule();
    ...
    RewriteRule make_fill_init_rule();
    RewriteRule make_floor_init_rule();
    ...
    // dataflow: pipe
    RewriteRule make_pipe_get_rule();
    RewriteRule make_pipe_set_rule();
